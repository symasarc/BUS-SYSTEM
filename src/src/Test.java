...
public class Test {
	...
	public static void main(String[] args) {
		...
		// Buses
		LuxuryBus bus1 = new LuxuryBus("Luxury", "06 ANK 5214", 40, new Seat[3][14]);
		ClassicBus bus2 = new ClassicBus("Classic", "11 BLC 9380", 46, new Seat[4][12]);
		...
		Passenger[] groupA = { passenger, passenger2, passenger9, passenger10, passenger11, passenger12, passenger13,
				passenger14 };
		bus2.sellSeat(groupA, 0);
		System.out.println();
		System.out.println("Sale Completed for group1: ");
		System.out.println();
		System.out.println(bus2.toString());

		Passenger[] groupB = { passenger3, passenger4, passenger5, passenger6, passenger7, passenger8 };
		bus2.sellSeat(groupB, 0.5);
		System.out.println();
		System.out.println("Sale Completed for group2: ");
		System.out.println();
		System.out.println(bus2.toString());
		...
		Passenger[] groupC = { passenger17, passenger18, passenger19, passenger20, passenger21, passenger22,
				passenger25, passenger26, passenger31, passenger33, passenger34 };
		bus2.sellSeat(groupC, 1);
		System.out.println();
		System.out.println("Sale Completed for group3: ");
		System.out.println();
		System.out.println(bus2.toString());

		Passenger[] groupD = { passenger23, passenger24, passenger27, passenger28, passenger29, passenger30,
				passenger35, passenger36, passenger37, passenger38, passenger39, passenger40, passenger41 };
		bus2.sellSeat(groupD, 0);
		System.out.println();
		System.out.println("Sale after group4: ");
		System.out.println();
		System.out.println(bus2.toString());
		...
		Passenger[] groupE = { passenger44, passenger45, passenger46, passenger47, passenger48, passenger49,
				passenger50 };
		bus2.sellSeat(groupE, 1);
		System.out.println();
